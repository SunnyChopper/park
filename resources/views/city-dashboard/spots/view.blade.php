							...
							@foreach($spots as $spot)
								<tr>
									...
									<td>
										...
										<a href="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl={%22spot_id%22:{{ $spot->id }},%22zone_id%22:{{ $spot->zone_id }}}" target="_blank" class="btn btn-primary mr-2" style="float: right;">Generate QR</a>
									</td>
